  ...
  return (
    <footer className="footer bg-dark text-light pt-5 mt-auto  ">
        ...
        Aak<span className="text-warning fs-2">a</span>sh
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              <li className="" ><Link className="footer-link text-decoration-none text-white" to="/">Home</Link></li>
              {/* <li className="" ><Link to="/about" className="footer-link text-decoration-none text-white">Shop</Link></li> */}
              <li className=""><Link to="/about" className="footer-link text-decoration-none text-white">About</Link></li>
              <li className=""><Link to="service" className="footer-link text-decoration-none text-white">Service</Link></li>
              <li className=""><Link to="/contact" className="footer-link text-decoration-none text-white">Contact</Link></li>
              <li className=""><Link to="/order" className="footer-link text-decoration-none text-white">Order history</Link></li>
            </ul>
          </div>
      ...
      <div className="text-center border-top mt-4 pt-3 small">
        ...
        <p>© 2024 Aakash. All rights reserved.</p>
      </div>
